  ...
  return (
    <footer className="relative w-full bg-black">
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="mx-auto grid w-full grid-cols-1 gap-4 py-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                {links.map((link, key) => (
                  ...
                  >
                    <Link
                      ...
                      className="inline-block py-1 pr-2 transition-transform hover:scale-110 hover:text-teal-400"
                    >
                      {link}
                    </Link>
                  </Typography>
          ...
          <div>
            <div className="flex items-center justify-center text-center gap-2 ">
              <svg
                className="text-center mt-auto w-6 h-6  text-teal-400 dark:text-white opacity-[0.9] mb-5"
                aria-hidden="true"
              ...
              <p className="text-white mt-4 opacity-[0.9]">
        ...
        <div className="flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {} <a href="https://material-tailwind.com/">Cloudifiers</a>.
            All Rights Reserved.
          </Typography>
          <div className="flex gap-4 text-white sm:justify-center">
            ...
            <Typography
              as="a"
              href="https://twitter.com/cloudifiers"
              className="opacity-80 transition-opacity hover:opacity-100 hover:scale-150 hover:text-teal-400"
            >
              <svg
                className="h-8 w-8"
            ...
            <Typography
              as="a"
              href="https://github.com/aws-App-MK/mk-aws"
              className="opacity-80 transition-opacity hover:opacity-100 hover:scale-150 hover:text-teal-400"
            >
              <svg
                className="h-8 w-8"
