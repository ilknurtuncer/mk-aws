...
const AboutUsFooter = () => {
    return (
        <div className=" w-full 3xl:container 2xl:mx-auto lg:py-20 lg:px-24 md:py-12 md:px-6 py-9 px-2">
            <div className="flex flex-col lg:flex-row justify-between gap-8">
                <div className="w-full lg:w-5/12 flex flex-col justify-center">
                    <h1 className="text-5xl lg:text-5xl font-bold leading-9 text-teal-500 p-4">About Us</h1>
                    <h3 className=" text-3xl text-teal-400 p-1">Our Mission</h3>
...
<h3 className=" text-3xl text-teal-400 p-1">AWS Expertise</h3>
<p className="font-normal text-base leading-6 text-gray-600 ">
...
<h3 className=" text-3xl text-teal-400 p-1">Full-Stack Web Design</h3>
<p className="font-normal text-base leading-6 text-gray-600 ">
...
<h3 className=" text-3xl text-teal-400 p-1 ">Client-Centric Approach</h3>
<p className="font-normal text-base leading-6 text-gray-600 ">
